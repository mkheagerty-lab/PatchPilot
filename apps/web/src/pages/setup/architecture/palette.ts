...
export const NODE_TOKENS: Record<NodeCategory, Token> = {
  actor: {
    label: "Person",
    chip: "bg-rose-100 dark:bg-rose-500/15 text-rose-700 dark:text-rose-400",
    fill: "#f43f5e",
    stroke: "#e11d48",
    dot: "bg-rose-500",
  },
  app: {
    label: "PatchPilot",
    chip: "bg-indigo-100 dark:bg-indigo-500/15 text-indigo-700 dark:text-indigo-300",
    fill: "#6366f1",
    stroke: "#4f46e5",
    dot: "bg-indigo-500",
  },
  ...
  device: {
    ...
    chip: "bg-emerald-100 dark:bg-emerald-500/15 text-emerald-700 dark:text-emerald-400",
    fill: "#10b981",
    stroke: "#059669",
    dot: "bg-emerald-500",
  },
