...
const bannerClass =
  "flex flex-wrap items-center justify-between gap-3 rounded-lg border border-amber-200 dark:border-amber-900/50 bg-amber-50 dark:bg-amber-500/10 px-4 py-2.5 text-sm text-amber-800";
const linkClass =
  "shrink-0 rounded-md border border-amber-300 bg-white dark:bg-slate-900 px-2.5 py-1 text-xs font-medium text-amber-800 transition-colors hover:bg-amber-100 dark:hover:bg-amber-500/15";
