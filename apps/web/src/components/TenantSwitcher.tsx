  ...
  return (
    <div ref={rootRef} className="relative flex items-center gap-2 text-sm">
      ...
      <button
        type="button"
        onClick={() => setOpen((o) => !o)}
        className="flex min-w-[12rem] items-center justify-between gap-2 rounded-md border border-slate-300 bg-white px-3 py-1.5 text-sm font-medium text-slate-800 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500"
      >
      ...
      {open && (
        <div className="absolute left-0 top-full z-20 mt-1 w-72 rounded-md border border-slate-200 bg-white shadow-lg">
          <div className="p-2">
            <input
              autoFocus
              type="search"
              ...
              className="w-full rounded-md border border-slate-200 px-2.5 py-1.5 text-sm text-slate-700 placeholder:text-slate-400 focus:border-indigo-400 focus:outline-none focus:ring-1 focus:ring-indigo-400"
            />
          </div>
            ...
            {allMatches && (
              <li>
                <button
                  ...
                  className={`flex w-full flex-col items-start border-b border-slate-100 px-3 py-2 text-left transition-colors hover:bg-slate-50 ${
                    isAllTenants ? "bg-indigo-50" : ""
                  }`}
                >
                  <span className="text-sm font-medium text-slate-800">All Tenants</span>
                ...
                <li key={t.id}>
                  <button
                    ...
                    className={`flex w-full flex-col items-start px-3 py-2 text-left transition-colors hover:bg-slate-50 ${
                      !isAllTenants && t.tenantId === activeTenantId ? "bg-indigo-50" : ""
                    }`}
                  >
